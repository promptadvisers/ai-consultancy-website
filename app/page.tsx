        ...
        <div className="container mx-auto container-padding">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 card-hover shadow-xl border border-white/20">
              <div className="w-16 h-16 bg-gradient-to-br from-deep-indigo to-vibrant-teal rounded-xl mb-6 flex items-center justify-center">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 card-hover shadow-xl border border-white/20">
              <div className="w-16 h-16 bg-gradient-to-br from-vibrant-teal to-lime-green rounded-xl mb-6 flex items-center justify-center">
                <div className="w-8 h-8 bg-white/20 rounded-lg"></div>
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 card-hover shadow-xl border border-white/20 sm:col-span-2 lg:col-span-1">
              <div className="w-16 h-16 bg-gradient-to-br from-lime-green to-deep-indigo rounded-xl mb-6 flex items-center justify-center">
                <div className="w-8 h-8 bg-white/20 rounded-lg"></div>
              </div>
